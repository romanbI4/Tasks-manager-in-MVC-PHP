...
<body>
    ...
    <p align="right"><a href="<?=$path?>/admin/logout" class="btn btn-success">Выход</a></p>
    <div id="update_box">
        <form method="POST" action="<?=$path?>/admin/updateTask">
    ...
    <div id="update_box">
        <form method="POST" action="<?=$path?>/admin/updateStatus">
            <label for="id_admin">Введите ид задачи</label>
            <input type="text" name="id_admin"/>
